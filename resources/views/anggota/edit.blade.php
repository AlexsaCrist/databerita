                    ...
                    <div class="card-body">
                      <h4 class="card-title">Edit Anggota</h4>
                        ...
                        <div class="form-group{{ $errors->has('npk') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="npk" type="number" class="form-control" name="npk" value="{{ $data->npk }}" maxlength="8" required>
                                @if ($errors->has('npk'))
                                    <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('posisi') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="posisi" required="">
                                <option value=""></option>
                                <option value="PD" {{$data->posisi === "PD" ? "selected" : ""}} >Pusdoc</option>
                                <option value="RD" {{$data->posisi === "RD" ? "selected" : ""}} >Redaksi</option>
                                <option value="UM" {{$data->posisi === "UM" ? "selected" : ""}} >Umum</option>
                            </select>
                            </div>
                        </div>
