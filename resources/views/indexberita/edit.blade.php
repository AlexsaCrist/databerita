...
<form method="POST" action="{{ route('indexberita.update', $data->id ) }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put') }}
<div class="row">
                    ...
                    <div class="card-body">
                      <h4 class="card-title">Edit Berita</h4>
                        ...
                        <div class="form-group{{ $errors->has('judul_berita') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="judul_berita" type="text" class="form-control" name="judul_berita" value="{{  $data->judul_berita }}" required >
                         ...
                         <div class="form-group{{ $errors->has('tanggal_berita') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-3">
                                <input id="tanggal_berita" type="date" class="form-control" name="tanggal_berita" value="{{  $data->tanggal_berita }}" required >
                        ...
                        <div class="form-group{{ $errors->has('jenis_1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="jenis_berita1" type="text" class="form-control" value="inputkan ulang"  required readonly="">
                                <input id="jenis_1" type="hidden" name="jenis_1" value="{{$data->jenis_1}}" required  readonly="">
                        ...
                        <div class="form-group{{ $errors->has('jenis_2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="jenis_berita2" type="text" class="form-control"  value="inputkan ulang" readonly="">
                                <input id="jenis_2" type="hidden" name="jenis_2" value="{{ $data->jenis_2 }}" required readonly="" >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('jenis_3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="jenis_berita3" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="jenis_3" type="hidden" name="jenis_3" value="{{ $data->jenis_3 }}" required readonly="" >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('katakunci') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="katakunci" type="text" class="form-control" name="katakunci" value="{{ $data->katakunci }}" required>
                        ...
                        <div class="form-group{{ $errors->has('penulis_1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama1" type="text" class="form-control" value="inputkan ulang"  required readonly="">
                                <input id="penulis_1" type="hidden" name="penulis_1" value="{{ $data->penulis_1 }}" required  readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama2" type="text" class="form-control" value="inputkan ulang" readonly="" >
                                <input id="penulis_2" type="hidden" name="penulis_2" value="{{ $data->penulis_2 }} " required  readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama3" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_3" type="hidden" name="penulis_3" value="{{ $data->penulis_3 }} " required  readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_4') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama4" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_4" type="hidden" name="penulis_4" value="{{ $data->penulis_4 }} " required readonly="" >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_5') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama5" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_5" type="hidden" name="penulis_5" value="{{ $data->penulis_5 }}"  required readonly="" >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_6') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama6" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_6" type="hidden" name="penulis_6" value="{{ $data->penulis_6 }} " required readonly=""  >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_7') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama7" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_7" type="hidden" name="penulis_7" value="{{ $data->penulis_7 }} " required  readonly="">
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_8') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama8" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_8" type="hidden" name="penulis_8" value="{{ $data->penulis_8 }}" required readonly="" >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_9') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama9" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_9" type="hidden" name="penulis_9" value="{{ $data->penulis_9 }}" required readonly="" >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('penulis_10') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                <input id="penulis_nama10" type="text" class="form-control" value="inputkan ulang" readonly=""  >
                                <input id="penulis_10" type="hidden" name="penulis_10" value="{{ $data->penulis_10 }} " required readonly="" >
                                <span class="input-group-btn">
                        ...
                        <div class="form-group{{ $errors->has('halaman_terbit') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="halaman_terbit" type="text" class="form-control" name="halaman_terbit" value="{{  $data->halaman_terbit }}" required>
                        ...
                        <div class="form-group{{ $errors->has('kolom_halaman') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="kolom_halaman" required="">
                                <option value="Kolom 1 Atas" {{$data->kolom_halaman === "Kolom 1 Atas" ? "selected" : ""}}>Kolom 1 Atas</option>
                                <option value="Kolom 2 Atas" {{$data->kolom_halaman === "Kolom 2 Atas" ? "selected" : ""}}>Kolom 2 Atas</option>
                                <option value="Kolom 3 Atas" {{$data->kolom_halaman === "Kolom 3 Atas" ? "selected" : ""}}>Kolom 3 Atas</option>
                                <option value="Kolom 4 Atas" {{$data->kolom_halaman === "Kolom 4 Atas" ? "selected" : ""}}>Kolom 4 Atas</option>
                                <option value="Kolom 5 Atas" {{$data->kolom_halaman === "Kolom 5 Atas" ? "selected" : ""}}>Kolom 5 Atas</option>
                                <option value="Kolom 6 Atas" {{$data->kolom_halaman === "Kolom 6 Atas" ? "selected" : ""}}>Kolom 6 Atas</option>
                                <option value="Kolom 1 bawah"{{$data->kolom_halaman === "Kolom 1 Bawah" ? "selected" : ""}}>Kolom 1 bawah</option>
                                <option value="Kolom 2 bawah"{{$data->kolom_halaman === "Kolom 2 Bawah" ? "selected" : ""}}>Kolom 2 bawah</option>
                                <option value="Kolom 3 bawah"{{$data->kolom_halaman === "Kolom 3 Bawah" ? "selected" : ""}}>Kolom 3 bawah</option>
                                <option value="Kolom 4 bawah"{{$data->kolom_halaman === "Kolom 4 Bawah" ? "selected" : ""}}>Kolom 4 bawah</option>
                                <option value="Kolom 5 bawah"{{$data->kolom_halaman === "Kolom 5 Bawah" ? "selected" : ""}}>Kolom 5 bawah</option>
                                <option value="Kolom 6 bawah"{{$data->kolom_halaman === "Kolom 6 Bawah" ? "selected" : ""}}>Kolom 6 bawah</option>
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group{{ $errors->has('jenis_berita') ? ' has-error' : '' }}">
                            ...
                            <select class="form-control" name="jenis_berita" required="">
                                <option value="Tertulis" {{$data->jenis_berita === "Tertulis" ? "selected" : ""}}>Tertulis</option>
                                <option value="Grafik" {{$data->jenis_berita === "Grafik" ? "selected" : ""}}>Grafik</option>
                            </select>
                            </div>
                        </div>
  ...
  <div class="modal-dialog modal-lg" role="document" >
    <div class="modal-content" style="background: #fff;">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Cari Jenis 1</h5>
